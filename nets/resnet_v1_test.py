...
class ResnetCompleteNetworkTest(tf.test.TestCase):
  ...
  def testClassificationEndPoints(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      logits, end_points = self._resnet_small(inputs, num_classes,
                                              ...
                                              scope='resnet_v2_101')
    self.assertTrue(logits.op.name.startswith('resnet_v2_101/logits'))
  ...
  def testEndpointNames(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      _, end_points = self._resnet_small(inputs, num_classes,
                                         global_pool=global_pool,
                                         scope='resnet_v2_101')
    expected = ['resnet_v2_101/conv1']
    for block in range(1, 5):
      for unit in range(1, 4 if block < 4 else 3):
        for conv in range(1, 4):
          expected.append('resnet_v2_101/block%d/unit_%d/bottleneck_v1/conv%d' %
                          (block, unit, conv))
        expected.append('resnet_v2_101/block%d/unit_%d/bottleneck_v1' % (block, unit))
      expected.append('resnet_v2_101/block%d/unit_1/bottleneck_v1/shortcut' % block)
      expected.append('resnet_v2_101/block%d' % block)
    expected.extend(['global_pool', 'resnet_v2_101/logits', 'resnet_v2_101/spatial_squeeze',
                     'predictions'])
  ...
  def testClassificationShapes(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      _, end_points = self._resnet_small(inputs, num_classes,
                                         ...
                                         scope='resnet_v2_101')
      endpoint_to_shape = {
          'resnet_v2_101/block1': [2, 28, 28, 4],
          'resnet_v2_101/block2': [2, 14, 14, 8],
          'resnet_v2_101/block3': [2, 7, 7, 16],
          'resnet_v2_101/block4': [2, 7, 7, 32]}
  ...
  def testFullyConvolutionalEndpointShapes(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      _, end_points = self._resnet_small(inputs, num_classes,
                                         ...
                                         scope='resnet_v2_101')
      endpoint_to_shape = {
          'resnet_v2_101/block1': [2, 41, 41, 4],
          'resnet_v2_101/block2': [2, 21, 21, 8],
          'resnet_v2_101/block3': [2, 11, 11, 16],
          'resnet_v2_101/block4': [2, 11, 11, 32]}
      for endpoint in endpoint_to_shape:
        shape = endpoint_to_shape[endpoint]
        self.assertListEqual(end_points[endpoint].get_shape().as_list(), shape)
  ...
  def testRootlessFullyConvolutionalEndpointShapes(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      _, end_points = self._resnet_small(inputs, num_classes,
                                         ...
                                         scope='resnet_v2_101')
      endpoint_to_shape = {
          'resnet_v2_101/block1': [2, 64, 64, 4],
          'resnet_v2_101/block2': [2, 32, 32, 8],
          'resnet_v2_101/block3': [2, 16, 16, 16],
          'resnet_v2_101/block4': [2, 16, 16, 32]}
      for endpoint in endpoint_to_shape:
        shape = endpoint_to_shape[endpoint]
        self.assertListEqual(end_points[endpoint].get_shape().as_list(), shape)
  ...
  def testAtrousFullyConvolutionalEndpointShapes(self):
    ...
    with slim.arg_scope(resnet_utils.resnet_arg_scope()):
      ...
      endpoint_to_shape = {
          'resnet_v2_101/block1': [2, 41, 41, 4],
          'resnet_v2_101/block2': [2, 41, 41, 8],
          'resnet_v2_101/block3': [2, 41, 41, 16],
          'resnet_v2_101/block4': [2, 41, 41, 32]}
      for endpoint in endpoint_to_shape:
        shape = endpoint_to_shape[endpoint]
        self.assertListEqual(end_points[endpoint].get_shape().as_list(), shape)
