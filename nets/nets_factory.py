...
excludes_map = {'alexnet_v2': [],
                ...
                'resnet_v2_200': [],
                'mobilenet_v1': [],
                'mobilenet_v1_100': ['MobilenetV1/Logits'],
                'mobilenet_v1_075': ['MobilenetV1/Logits'],
                'mobilenet_v1_050': ['MobilenetV1/Logits'],
                'mobilenet_v1_025': ['MobilenetV1/Logits'],
                'mobilenet_v2': [],
                'mobilenet_v2_100': ['MobilenetV2/Logits'],
                'mobilenet_v2_140': ['MobilenetV2/Logits'],
                'nasnet_cifar': [],
                'nasnet_mobile': ['final_layer/FC'],
                'nasnet_large': ['final_layer/FC'],
                'pnasnet_large': ['final_layer/FC'],
                'nasnet_plarge': ['final_layer/FC'],
                }
arg_scopes_map = {'alexnet_v2': alexnet.alexnet_v2_arg_scope,
                  ...
                  'mobilenet_v1_100': mobilenet_v1.mobilenet_v1_arg_scope,
                  'mobilenet_v1_075': mobilenet_v1.mobilenet_v1_arg_scope,
                  'mobilenet_v1_050': mobilenet_v1.mobilenet_v1_arg_scope,
                  'mobilenet_v1_025': mobilenet_v1.mobilenet_v1_arg_scope,
                  'mobilenet_v2': mobilenet_v2.training_scope,
                  'mobilenet_v2_100': mobilenet_v2.training_scope,
                  ...
                  'nasnet_plarge': pnasnet.pnasnet_large_arg_scope,
                  }


def get_network_fn(name, num_classes=1000, weight_decay=0.0, is_training=False):
